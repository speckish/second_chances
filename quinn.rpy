label quinn:
    ...
    q "That's right."
    yuki
    show quinn neutral at seated with move
    ...
    yuki sad
    "He thought about Quinn's words. She was facing her own struggles, her own challenges. But the past him didn't see that."
    yuki sad blush
    "He was too obsessed with himself, his own notions of beauty and romance."
    yuki shocked
    ...
    scene bg forest
    show quinn shocked sweat blush
    with fade
    yuki blush sweat
    y "{i}pant{/i}"
    q "{i}pant{/i}"
    y "So..."
    show quinn sad sweat blush
    q "U-Um... t-that was... w-well..."
    yuki happy blush
    "Yuki smiled at her nervous words."
    y "I care about you, Quinn. I love how kind you are to others and how you smile when looking at the plants."
    y "I truly love the way your face lights up when you talk about something you love."
    yuki blush
...
label .ending:
    show quinn sad blush with dissolve
    "Quinn stood in the doorway, her face flushed with exertion."
    show quinn angry blush at yell
    ...
    menu:
        "To cast the spell":
            call .bad from _call_quinn_bad
        "Not to cast the spell":
            call .good from _call_quinn_good
    return
...
label .bad:
    ...
    show quinn shocked blush at yell
    q "Yuki...! Yuki!!"
    yuki shocked blush
    ...
    scene bg yukis_cabin_inside open_door with fade
    qu
    ...
    show cat smug flip with dissolve
    cat "..."
    show cat smirk flip
...
label .good:
    ...
    show quinn shocked blush at startle
    yuki sad sweat blush
    ...
    "This wasn't the end."
    yuki None
    show cat smirk at offscreenright
    pause 0.0
    show cat:
        align (0.5, 0.5)
    show quinn at offscreenleft
